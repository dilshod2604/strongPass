        ...
        <div className="flex items-center flex-col justify-center w-[100%] gap-[40px] ">
          ...
          <div className="flex items-center gap-[20px] max-lg:flex-col gap-y-[40px]">
            ...
            <div className="max-w-[450px] lg:h-[700px] relative bg-[#F2F5F4] rounded-[10px] p-[40px] flex items-center flex-col justify-center gap-[30px]">
              ...
              <div className="flex items-center">
                <button className="sm:py-[10px] max-sm:py-[12px] sm:px-[50px] max-sm:px-[20px] sm:text-[18px]  max-sm:text-[14px] text-[#408077] font-[600] rounded-[10px] border-2 border-solid border-[#408077] hover:bg-[#408077] hover:text-white transition-all">
