    ...
    <section>
      <div className="container">
        <div className="mt-[60px]">
          <h1 className="text-[64px] font-[700] text-[#262F33]">Продукты</h1>
          ...
          <div className="flex items-center justify-between mt-[67px]">
            {/* BLOCK  */}
            <div className="w-[380px] h-[440px] bg-[#F2F5F4] px-[27px] py-[27px] rounded-[30px]">
              ...
              <h2 className="text-[29px] font-[600] text-[#262F33] mt-[24px]">Проактивная <br /> защита</h2>
              ...
              <div className="flex items-center justify-between mt-[25px]">
                ...
                <div className="flex items-center">
                  <button className="border-2 border-[#408077] bg-transparent text-[#408077] py-[10px] px-[30px] rounded-[13px] hover:bg-[#408077] hover:text-white transition-all">Подробнее</button>
            ...
            <div className="w-[380px] h-[440px] bg-[#F2F5F4] px-[27px] py-[27px] rounded-[30px]">
              ...
              <h2 className="text-[29px] font-[600] text-[#262F33] mt-[24px]">Самопроверка</h2>
              <p className="text-[#262F33] text-[18px] font-[400] mt-[10px]">
            ...
            <div className="w-[380px] h-[440px] bg-[#F2F5F4] px-[27px] py-[27px] rounded-[30px]">
              ...
              <h2 className="text-[29px] font-[600] text-[#262F33] mt-[24px]">Almetibin</h2>
              <p className="text-[#262F33] text-[18px] font-[400] mt-[10px]">
              Безопасный обмен паролями, <br /> чувствительной информацией <br /> с контрагентами или внутри <br /> компании.
              </p>
